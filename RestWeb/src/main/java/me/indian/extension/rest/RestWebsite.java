...
import me.indian.extension.rest.config.RestApiConfig;
import me.indian.bds.extension.Extension;
import me.indian.bds.logger.Logger;
import me.indian.bds.util.GsonUtil;
import me.indian.extension.rest.post.key.CommandPostRequest;
import me.indian.extension.rest.post.key.PlayerInfoPostRequest;
import me.indian.extension.rest.post.key.discord.DiscordMessagePostRequest;
import me.indian.extension.rest.request.StatsRequest;
import me.indian.extension.rest.request.key.BackupRequest;
...
public class RestWebsite extends Extension {
    ...
    public RestWebsite(final BDSAutoEnable bdsAutoEnable) {
        ...
        this.restApiConfig = this.createConfig(RestApiConfig.class , "config.yml");
    ...
    public void onEnable() {
        new RestWebsite(this.getBdsAutoEnable());
    }
